...
# Use known working addresses from simple_test.sh
...
echo "0x3C44CdDdB6a900fa2b585dd299e03d12f4b1e4" >> "${ACCOUNTS_FILE}"
echo "0x90F79bf6EB2c4f870365E785982EaC365Cee3e1" >> "${ACCOUNTS_FILE}"
...
echo "0x3C44CdDdB6a900fa2b585dd299e03d12f4b1e4|5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a" >> "${PRIVATE_KEYS_FILE}"
echo "0x90F79bf6EB2c4f870365E785982EaC365Cee3e12f|7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6" >> "${PRIVATE_KEYS_FILE}"
